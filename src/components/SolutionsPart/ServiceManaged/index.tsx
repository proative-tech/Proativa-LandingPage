          ...
          {children ? (
            ...
            <>
              <Header>
                ...
                <h1>
                  Já imaginou sair do seu escritório todos os dias sabendo que a
                  segurança e a continuidade do seu negócio estão em boas mãos?
                </h1>
                <p>
                  Os Serviços Gerenciados da Proative fazem exatamente isso - 24
                  horas por dia, 7 dias por semana. Unindo gestão, inteligência,
                  segurança, agilidade e inovação.
                </p>
              </Header>
              <Footer>
                <h3>Seja Proativo</h3>
