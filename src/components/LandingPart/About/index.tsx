...
export const About = () => {
  return (
    <Container>
        <ContainerImg>
          <img src="/images/home.png" alt="proative"/>
        </ContainerImg>
        <Content>
          <Header>
            ...
            <p>Oferecemos soluções de gerenciamento de TI que te possibilitam
            ...
            de performance com segurança, agilidade, eficiência e colaboração.</p>
          </Header>
          <Footer>
            <h3>História</h3>
